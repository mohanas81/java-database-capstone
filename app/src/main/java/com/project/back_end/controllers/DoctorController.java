...
public class DoctorController {
    ...
    @GetMapping(value = "/availability/{user}/{doctorId}/{date}/{token}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/register/{token}", produces = MediaType.APPLICATION_JSON_VALUE)
